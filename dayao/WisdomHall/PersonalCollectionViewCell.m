...
-(void)setPersonalInfo:(SignPeople *)sign{
    ...
    if (![UIUtils isBlankString:[NSString stringWithFormat:@"%@",sign.pictureId]]) {
       [_headImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@?resourceId=%@",base,FileDownload,sign.pictureId]] placeholderImage:[UIImage imageNamed:@"sign.png"]];
    }else{
